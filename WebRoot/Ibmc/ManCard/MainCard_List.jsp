...
<div id="container" style="width:82%; float:left;">
    ...
    <!-- 标题区域 --->
    <div class="titleArea">
        <div class="titleClass">业主卡管理</div>
    </div>
    <!-- 分隔符 --->
    <div class="lineSpac"></div>
    <!-- 查询条件 --->
    ...
    <div class="gridDiv">
        <div id="dataPagi"></div>
        <div id="btnGroup">
            <button class="btn btn-info" id="insert" onClick="setManCard();">业主卡管理</button>
        </div>
        <div class="clear"/>
...
<script type="text/javascript">
    ...
    function setManCard() {
	    ...
	    var url = "<c:url value="/Man/Card/ownercardwin.shtml"/>?querymap.houseid="+selectedId;
        parent.$.jBox.open("iframe:"+url, "业主卡管理", 800, 480, { buttons: {}});
    }
