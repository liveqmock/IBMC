...
<div id="container">
    ...
    <!-- 标题区域 --->
    <div class="titleArea">
        <div class="titleClass">${houseBean.commname}[${houseBean.ownername }]-业主卡列表</div>
    </div>
    <!-- 分隔符 --->
    <div class="lineSpac"></div>
    <!-- 查询条件 --->
    <div class="mySearchMain" id="mySearchMain">
        <form method="post" name="form" id="form1" action="">
            ...
            <input type="button" class="btn btn-info" id="insert"  style="float:right;margin-right:10px;" value="生成业主卡"/>
        </form>
    </div>
    <!-- 分隔符 --->
    <div class="lineSpac"></div>
    ...
    <div class="gridDiv" id="listFormId">
        ...
        <div id="btnGroup">
            ...
            <button class="btn btn-danger" id="delete">注销业主卡</button>
        </div>
        <div class="clear"/>
...
<div class="editContainer" id="editFormId">
    ...
    <div>
        ...
        <table class="editTable">
            <tbody>
            <tr>
                <td colspan="2" style="font-weight: bold;">生成业主卡</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="right">
                    <input type="text" id="b_cardno" value="" class="text_20line"/>（绑定IC卡/身份证）
