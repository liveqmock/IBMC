...
<div id="container" style="width:82%; float:left;">
    ...
    <!-- 标题区域 --->
    <div class="titleArea">
        <div class="titleClass">房产信息查询</div>
    </div>
    <!-- 分隔符 --->
    <div class="lineSpac"></div>
    <!-- 查询条件 --->
    ...
    <div class="gridDiv">
        <div id="dataPagi"></div>
        <div id="btnGroup">
            <button class="btn btn-info" id="btn_export" style="display:none;">导出房产列表</button>&nbsp;|&nbsp;
...
<script type="text/javascript">
    ...
    function operRecord(flag){
    	if(flag=="9"){
    		...
    		url = "<c:url value='/Man/House/setmanhouseromm_query.shtml'/>";
